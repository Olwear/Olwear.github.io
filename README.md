...
**[提瓦特大地图](https://webstatic.mihoyo.com/ys/app/interactive-map/?lang=zh-cn#/map/2?shown_types=)** **找神瞳、宝箱等之用**
...
* #### 祈愿
  ...
  * 喜欢的的角色UP拉满，中后期适当投资武器UP（**不要忘了每月星尘兑换祈愿石头**）

* #### 队伍配置

  * 单主C和三拐阵容，主升C，工具人适当培养(**不必理会各种角色保值的说法，节省资源，有五星玩五星**)
  * 剧变反应队作为开局阵容相当推荐，只需要等级和精通。
...
|   生之花   |  死之羽   |      时之沙       |      空之杯       |    理之冠     |
| :--------: | :-------: | :---------------: | :---------------: | :-----------: |
| 生命值4780 | 攻击力311 |    生命值46.6%    |    生命值46.6%    |  生命值46.6%  |
|            |           |    攻击力46.6%    |    攻击力46.6%    |  攻击力46.6%  |
|            |           |    防御力58.3%    |    防御力58.3%    |  防御力58.3%  |
|            |           |    元素精通187    |    元素精通187    |  元素精通187  |
|            |           | 元素充能效率51.8% | 元素伤害加成46.6% |  暴击率31.1%  |
|            |           |                   | 物理伤害加成58.3% | 暴击伤害62.2% |
|            |           |                   |                   | 治疗加成35.9% |
...
* **针对深境大型精英怪的无敌爆破，可以通过各种无敌帧在极其安全的环境下输出，尤其对于遗迹系列的精英怪物有强大的压制作用，不仅限于遗迹精英怪**

* **刻晴**

  * 作为尴尬的战场C，这一次作为副C可以毫无顾及的输出，EQ完事
...
* **配置要求**
  ...
  * 刻晴，菲谢尔无脑输出向，香菱适当考虑充能，班尼特主充能副生命。由于班尼特的攻击加成几乎全覆盖，全队攻击力作为次要因素

* **输出手法**

  * 班尼特QE，香菱QE，菲谢尔E&#124;Q,刻晴站场Q接高空E坠击，适当拉开距离，实现高度循环
